...
public class DeviceDetailDataFetcher implements DataFetcher<GetDeviceDetails200Response>, Serializable {
    ...
    public List<GetDeviceDetails200Response> fetch(DataFetchContext context) {
        try {
            ...
            List<? extends ListDevices200ResponseInner> devices = context.getSession().get(ListDevices200ResponseInner.class);
    ...
    public DataFormat getDataFormat() {
        return DataFormats.beansConvention(GetDeviceDetails200Response.class);
    }
}
